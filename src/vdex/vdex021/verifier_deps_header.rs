...
pub struct VerifierDepsHeader {
    ...
    pub bootclasspath_checksum_size: u32,
    pub class_loader_context_size: u32,
}
...
mod tests {
    ...
    fn verifier_deps_header_size_check() {
        assert_eq!(::std::mem::size_of::<VerifierDepsHeader>(), 0x1c);
    }
}

impl VerifierDepsHeader {
    pub fn has_dex_section(&self) -> bool {
        self.dex_section_version != crate::vdex::vdex021::DEX_SECTION_VERSION_EMPTY
    }
}
